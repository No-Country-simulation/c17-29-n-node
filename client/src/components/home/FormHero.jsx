...
export const FormHero = () => {
    ...
    return (
        <form action="" className='flex flex-col md:flex-row gap-2 md:gap-4 [&>*>input]:px-8 w-full md:[&>*]:w-fit [&_*]:placeholder:text-lg md:[&_*]:placeholder:text-tiny' onSubmit={handleSubmit}>
